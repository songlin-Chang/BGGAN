...
from lib.train_utils import seed_everything, load_json, load_netD, prepare_models
...
if __name__ == "__main__":
    ...
    netD = load_netD(net, r'/data/bggan/code/savemodel/state_epoch_600.pth', False, False)
    ...
    start = torch.full(size=(1, 1),
                        ...
                        device=device)
    with torch.no_grad():
        imgs_enc = image_enc(imgs, image_encoder, netD)  # [1, is, ie]
