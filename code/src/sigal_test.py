...
import cv2
from tools.dataloader import HDF5Dataset, collate_padd
from models.model import NetGIT
from models.model import ImageEncoder
from models.transformer import Transformer
from lib.nlg_metrics import Metrics
from tools.train_utils import seed_everything, load_json, load_netGIT, prepare_models
from tools.test_utils import parse_arguments
from tools.gpu_cuda_helper import select_device
...
if __name__ == "__main__":
    ...
    image_path = "/data/coding/bggan/data/CXR42_IM-2063-2001.png"
    ...
    net = NetGIT(32)
    netGIT = load_netGIT(net,r'/data/coding/bggan/code/premodel/state_epoch_420.pth', False, False)
